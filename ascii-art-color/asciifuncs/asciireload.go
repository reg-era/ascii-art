...
func IsBanner(filePrint string) bool {
	if filePrint == "standard" || filePrint == "thinkertoy" || filePrint == "shadow" || filePrint == "money" || filePrint == "standard.txt" || filePrint == "thinkertoy.txt" || filePrint == "shadow.txt" || filePrint == "money.txt" {
		return true
	}
	return false
}
